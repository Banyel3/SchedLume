    ...
    <div className="px-4 sm:px-6 py-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 h-11 px-4 text-sm font-medium rounded-xl border transition-colors ${
                action === "edit"
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full h-11 px-4 text-base border border-surface-300 rounded-xl bg-surface-100 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent focus:bg-white transition-colors"
            />
          </div>
      ...
      {action === "cancel" && (
        <div className="bg-red-50 rounded-xl p-4">
          <p className="text-sm text-red-700">
            This will mark <strong>{subjectName}</strong> as canceled for this
            day only. The class will still appear in your schedule but marked as
            canceled.
          </p>
        </div>
      )}
      ...
      {existingClass?.overrideId && !existingClass.isAdded && (
        <button
          ...
          disabled={saving}
          className="w-full text-center text-sm text-red-500 hover:text-red-700 py-3 rounded-xl hover:bg-red-50 transition-colors"
        >
