      ...
      <main className="max-w-lg mx-auto p-4 space-y-6">
        ...
        <section className="bg-white rounded-2xl shadow-card overflow-hidden">
          <div className="p-4 border-b border-surface-200">
            ...
            <p className="text-sm text-gray-500 mt-1">Import your class schedule from a CSV file</p>
          </div>
          <div className="p-4">
            ...
            {settings.lastImportedFileName && (
              <div className="mt-4 p-3 bg-surface-100 rounded-lg">
                ...
                <p className="text-sm font-medium text-gray-700">{settings.lastImportedFileName}</p>
        ...
        <section className="bg-white rounded-2xl shadow-card overflow-hidden">
          <div className="p-4 border-b border-surface-200">
            ...
            <p className="text-sm text-gray-500 mt-1">Export or clear your data</p>
          </div>
            ...
            {!showClearConfirm ? (
              ...
              <div className="p-4 bg-red-50 rounded-xl space-y-3">
                <p className="text-sm text-red-700">
                  This will permanently delete all your schedules, notes, and settings. This action cannot be undone.
                </p>
        ...
        <section className="bg-white rounded-2xl shadow-card overflow-hidden">
          ...
          <div className="p-4">
            ...
            <p className="text-sm text-gray-500 mt-4">
              A mobile-first, offline-capable class schedule viewer. Your data is stored locally on your device.
            </p>
          </div>
        </section>
      </main>
